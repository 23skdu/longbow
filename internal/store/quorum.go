...
func (qm *QuorumManager) ExecuteWrite(
	...
	if quorumMet {
		...
		metrics.QuorumFailureTotal.WithLabelValues("write", level.String(), "quorum_not_met").Inc()
	}
...
func (qm *QuorumManager) ExecuteRead(
	...
	if quorumMet {
		...
		metrics.QuorumFailureTotal.WithLabelValues("read", level.String(), "quorum_not_met").Inc()
	}
