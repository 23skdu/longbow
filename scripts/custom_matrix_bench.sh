...
SEARCH_MODES="Dense,Hybrid,Sparse,Filtered,ByID,GraphRAG,Geo,Temporal,LearnedIndex"

HOST=$(hostname)
MODE=$1 # "cpu" or "metal" or "cuda" or "avx2"
...
echo "========================================="
echo "CUSTOM Matrix Benchmark: $HOST ($MODE)"
echo "Output: $OUTPUT_DIR"
echo "Allocation: 18GB"
echo "========================================="
...
for count in "${COUNTS[@]}"; do
    for dim in "${DIMS[@]}"; do
        for dtype in "${DTYPES[@]}"; do
            ...
            # Wait for pprof to finish if it's still running
