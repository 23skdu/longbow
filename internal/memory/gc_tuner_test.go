...
func TestGCTuner_Logic(t *testing.T) {
	...
	tests := []struct {
		...
		{"Low Usage (10%)", uint64(10 * 1024 * 1024), 100},     // < 50% -> High
		{"Mid Usage (50%)", uint64(50 * 1024 * 1024), 100},     // = 50% -> High
		{"High Usage (90%)", uint64(90 * 1024 * 1024), 10},     // = 90% -> Low
		{"Critical Usage (95%)", uint64(95 * 1024 * 1024), 10}, // > 90% -> Low
		{"Interpolated (70%)", uint64(70 * 1024 * 1024), 55},   // Halfway between 0.5 and 0.9 -> Halfway between 100 and 10 = ~55
	}
