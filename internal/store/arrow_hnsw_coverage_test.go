...
func TestArrowHNSW_Coverage_ExtractVectorByIDForParallel(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:       "Float32",
			dataType:   lbtypes.VectorTypeFloat32,
			vectorDims: 4,
		...
		{
			name:       "Float64",
			dataType:   lbtypes.VectorTypeFloat64,
			vectorDims: 4,
		...
		{
			name:       "Float16",
			dataType:   lbtypes.VectorTypeFloat16,
			vectorDims: 4,
			vector: []float16.Num{
		...
		{
			name:       "Int8",
			dataType:   lbtypes.VectorTypeInt8,
			vectorDims: 4,
			vector:     []int8{1, 2, 3, 4},
		...
		{
			name:       "Uint8",
			dataType:   lbtypes.VectorTypeUint8,
			vectorDims: 4,
		...
		{
			name:       "Complex64",
			dataType:   lbtypes.VectorTypeComplex64,
			vectorDims: 2,
		...
		{
			name:       "Complex128",
			dataType:   lbtypes.VectorTypeComplex128,
			vectorDims: 2,
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			gd.SQ8Ready = true // For Int8/Uint8 GetVector
			h.data.Store(gd)
