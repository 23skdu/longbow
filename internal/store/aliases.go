...
func NewPeerReplicator(cfg cluster.ReplicatorConfig) *PeerReplicator { return cluster.NewPeerReplicator(cfg) }
func DefaultReplicatorConfig() cluster.ReplicatorConfig { return cluster.DefaultReplicatorConfig() }
func DefaultFlightClientPoolConfig() FlightClientPoolConfig { return cluster.DefaultFlightClientPoolConfig() }
func NewFlightClientPool(cfg FlightClientPoolConfig) *FlightClientPool { return cluster.NewFlightClientPool(cfg) }
func NewChangeDataCapture(s cluster.CDCStore, l zerolog.Logger) *ChangeDataCapture { return cluster.NewChangeDataCapture(s, l) }
func NewSplitBrainDetector(cfg cluster.SplitBrainConfig) *SplitBrainDetector { return cluster.NewSplitBrainDetector(cfg) }
...
func NewBM25InvertedIndex(cfg index.BM25Config) *BM25InvertedIndex { return index.NewBM25InvertedIndex(cfg) }
...
func NewBM25ArenaIndex(arena *memory.SlabArena, offset int) *BM25ArenaIndex { return index.NewBM25ArenaIndex(arena, offset) }
func NewShardedHNSW(cfg index.ShardedHNSWConfig, dp types.IndexDataProvider) index.VectorIndex { return index.NewShardedHNSW(cfg, dp) }
...
func NewIndexPerformancePredictor(l zerolog.Logger, cfg index.LearnedIndexConfig) *IndexPerformancePredictor { return index.NewIndexPerformancePredictor(l, cfg) }
func NewLearnedIndexRateLimiter(p *IndexPerformancePredictor, l zerolog.Logger) *LearnedIndexRateLimiter { return index.NewLearnedIndexRateLimiter(p, l) }
func NewRuntimeIndexAdapter(l zerolog.Logger, p *IndexPerformancePredictor, cfg IndexAdaptationConfig, m index.MetricsCollector) *RuntimeIndexAdapter { return index.NewRuntimeIndexAdapter(l, p, cfg, m) }
...
func NewPluggableInternalAdapter(i index.PluggableVectorIndex, dp types.IndexDataProvider) index.VectorIndex { return index.NewPluggableInternalAdapter(i, dp) }
func NewInvertedIndex() *InvertedIndex { return index.NewInvertedIndex() }
type ConsistencyLevel = cluster.ConsistencyLevel
func ParseConsistencyLevel(s string) (ConsistencyLevel, error) { return cluster.ParseConsistencyLevel(s) }
...
func NewIVFHNSWCompositeIndex(d int, cfg IVFHNSWConfig) (*index.IVFHNSWCompositeIndex, error) { return index.NewIVFHNSWCompositeIndex(d, cfg) }
type IVFOPQConfig = index.IVFOPQConfig
func NewIVFOPQIndex(d int, cfg IVFOPQConfig) (*index.IVFOPQIndex, error) { return index.NewIVFOPQIndex(d, cfg) }

type LearnedIndexWithOllama = index.LearnedIndexWithOllama
type OllamaConfig = index.OllamaConfig
func NewLearnedIndexWithOllama(l zerolog.Logger, p *IndexPerformancePredictor, cfg OllamaConfig) *LearnedIndexWithOllama { return index.NewLearnedIndexWithOllama(l, p, cfg) }
