...
func FastPathLess(ctx context.Context, arr arrow.Array, value string) (arrow.Array, error) {
	return fastPathCompareOrdered(ctx, arr, value, FilterOpLess)
}
...
func FastPathGreater(ctx context.Context, arr arrow.Array, value string) (arrow.Array, error) {
	return fastPathCompareOrdered(ctx, arr, value, FilterOpGreater)
}
...
func FastPathLessEqual(ctx context.Context, arr arrow.Array, value string) (arrow.Array, error) {
	return fastPathCompareOrdered(ctx, arr, value, FilterOpLessEqual)
}
...
func FastPathGreaterEqual(ctx context.Context, arr arrow.Array, value string) (arrow.Array, error) {
	return fastPathCompareOrdered(ctx, arr, value, FilterOpGreaterEqual)
}
...
// fastPathCompareOrdered is the implementation for ordered comparisons (<, >, <=, >=).
func fastPathCompareOrdered(_ context.Context, arr arrow.Array, value string, op FilterOperator) (arrow.Array, error) {
	alloc := memory.NewGoAllocator()
	builder := array.NewBooleanBuilder(alloc)
	defer builder.Release()
	...
	default:
		return nil, fmt.Errorf("fast path ordered comparison not supported for type: %v", arr.DataType())
	}
...
func fastPathInt64Ordered(arr *array.Int64, val int64, op FilterOperator, builder *array.BooleanBuilder) {
	values := arr.Int64Values()
	n := arr.Len()
	for i := 0; i < n; i++ {
		if arr.IsNull(i) {
...
func fastPathInt32Ordered(arr *array.Int32, val int32, op FilterOperator, builder *array.BooleanBuilder) {
	values := arr.Int32Values()
	n := arr.Len()
	for i := 0; i < n; i++ {
		if arr.IsNull(i) {
...
func fastPathUint64Ordered(arr *array.Uint64, val uint64, op FilterOperator, builder *array.BooleanBuilder) {
	values := arr.Uint64Values()
	n := arr.Len()
	for i := 0; i < n; i++ {
		if arr.IsNull(i) {
...
func fastPathUint32Ordered(arr *array.Uint32, val uint32, op FilterOperator, builder *array.BooleanBuilder) {
	values := arr.Uint32Values()
	n := arr.Len()
	for i := 0; i < n; i++ {
		if arr.IsNull(i) {
...
func fastPathFloat64Ordered(arr *array.Float64, val float64, op FilterOperator, builder *array.BooleanBuilder) {
	values := arr.Float64Values()
	n := arr.Len()
	for i := 0; i < n; i++ {
		if arr.IsNull(i) {
...
func fastPathFloat32Ordered(arr *array.Float32, val float32, op FilterOperator, builder *array.BooleanBuilder) {
	values := arr.Float32Values()
	n := arr.Len()
	for i := 0; i < n; i++ {
		if arr.IsNull(i) {
...
func fastPathInt16Ordered(arr *array.Int16, val int16, op FilterOperator, builder *array.BooleanBuilder) {
	values := arr.Int16Values()
	n := arr.Len()
	for i := 0; i < n; i++ {
		if arr.IsNull(i) {
...
func fastPathInt8Ordered(arr *array.Int8, val int8, op FilterOperator, builder *array.BooleanBuilder) {
	values := arr.Int8Values()
	n := arr.Len()
	for i := 0; i < n; i++ {
		if arr.IsNull(i) {
...
func fastPathUint16Ordered(arr *array.Uint16, val uint16, op FilterOperator, builder *array.BooleanBuilder) {
	values := arr.Uint16Values()
	n := arr.Len()
	for i := 0; i < n; i++ {
		if arr.IsNull(i) {
...
func fastPathUint8Ordered(arr *array.Uint8, val uint8, op FilterOperator, builder *array.BooleanBuilder) {
	values := arr.Uint8Values()
	n := arr.Len()
	for i := 0; i < n; i++ {
		if arr.IsNull(i) {
