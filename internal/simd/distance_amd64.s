...
cv5_reduce:
    VEXTRACTF64X4 $1, Z0, Y0; VADDPS Y0, Y0, Y0
    VEXTRACTF64X4 $1, Z1, Y1; VADDPS Y1, Y1, Y1
    VEXTRACTF64X4 $1, Z2, Y2; VADDPS Y2, Y2, Y2
    VEXTRACTF64X4 $1, Z3, Y3; VADDPS Y3, Y3, Y3
    VEXTRACTF64X4 $1, Z4, Y4; VADDPS Y4, Y4, Y4
    VEXTRACTF64X4 $1, Z5, Y5; VADDPS Y5, Y5, Y5
    VEXTRACTF64X4 $1, Z6, Y6; VADDPS Y6, Y6, Y6
    VEXTRACTF64X4 $1, Z7, Y7; VADDPS Y7, Y7, Y7
    VEXTRACTF64X4 $1, Z8, Y8; VADDPS Y8, Y8, Y8

    VEXTRACTF128 $1, Z0, X0; VADDPS X0, X0, X0
    VEXTRACTF128 $1, Z1, X1; VADDPS X1, X1, X1
    VEXTRACTF128 $1, Z2, X2; VADDPS X2, X2, X2
    VEXTRACTF128 $1, Z3, X3; VADDPS X3, X3, X3
    VEXTRACTF128 $1, Z4, X4; VADDPS X4, X4, X4
    VEXTRACTF128 $1, Z5, X5; VADDPS X5, X5, X5
    VEXTRACTF128 $1, Z6, X6; VADDPS X6, X6, X6
    VEXTRACTF128 $1, Z7, X7; VADDPS X7, X7, X7
    VEXTRACTF128 $1, Z8, X8; VADDPS X8, X8, X8
...
dotv5_reduce:
    VEXTRACTF64X4 $1, Z0, Y4; VADDPS Y4, Y4, Y4
    VEXTRACTF64X4 $1, Z1, Y4; VADDPS Y4, Y4, Y4
    VEXTRACTF64X4 $1, Z2, Y4; VADDPS Y4, Y4, Y4
    VEXTRACTF64X4 $1, Z3, Y4; VADDPS Y4, Y4, Y4

    VEXTRACTF128 $1, Z0, X4; VADDPS X4, X4, X4
    VEXTRACTF128 $1, Z1, X4; VADDPS X4, X4, X4
    VEXTRACTF128 $1, Z2, X4; VADDPS X4, X4, X4
    VEXTRACTF128 $1, Z3, X4; VADDPS X4, X4, X4
