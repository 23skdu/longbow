...
Longbow includes an embedded **DuckDB** adapter that allows you to run complex
SQL OLAP queries directly against your Parquet snapshots without loading them
into the main memory.

### How It Works

The Meta Server (port 3001) exposes a `query_analytics` action via the Arrow
Flight DoAction interface. This action:
...
- **Ad-hoc Analytics**: "What is the average vector norm for data ingested
  yesterday?"
