...
| Parameter | Value |
|-----------|-------|
| Dimensions | 384, 768, 1024, 1536, 2048, 3072 |
| Batch Sizes | 1,000, 3,000, 5,000, 7,000, 10,000, 15,000 |
| Data Types | float32, float64, float16, int8, int16, int32, int64, uint8, uint16, uint32, uint64, complex64, complex128 |
...
* **int16, int64, uint16, uint64 query vectors**: Currently requires float32 conversion for search. Native query type support is planned for future releases.
* Results include Dense, Hybrid, Filtered, and ByID search types across all supported dimensions.
...
|-------|---------|---------|---------|----------|----------|
| **float32** | N/A | 384,289 | 213,919 | 156,248 | 84,273 |
| **float64** | N/A | 270,060 | 152,964 | 69,752 | 44,816 |
| **float16** | N/A | 566,332 | 442,519 | 252,924 | 149,553 |
| **int8** | N/A | 605,144 | 470,634 | 416,587 | 245,361 |
| **int16** | N/A | 503,958 | 400,267 | 265,666 | 149,725 |
| **int32** | N/A | 412,506 | 272,873 | 159,970 | 89,070 |
| **int64** | N/A | 274,414 | 168,944 | 77,090 | 45,447 |
| **uint8** | N/A | 640,222 | 480,384 | 362,768 | 265,173 |
| **uint16** | N/A | 501,809 | 426,560 | 230,397 | 166,883 |
| **uint32** | N/A | 412,088 | 265,963 | 162,645 | 90,085 |
| **uint64** | N/A | 268,661 | 161,467 | 91,820 | 45,463 |
...
| DType | Dim 128 | Dim 384 | Dim 768 | Dim 1536 | Dim 3072 |
|-------|---------|---------|---------|----------|----------|
| **float32** | N/A | 562.9 | 626.7 | 915.5 | 987.6 |
| **float64** | N/A | 791.2 | 896.3 | 817.4 | 1,050.4 |
| **float16** | N/A | 414.8 | 648.2 | 741.0 | 876.3 |
| **int8** | N/A | 221.6 | 344.7 | 610.2 | 718.8 |
| **int16** | N/A | 369.1 | 586.3 | 778.3 | 877.3 |
| **int32** | N/A | 604.3 | 799.4 | 937.3 | 1,043.8 |
| **int64** | N/A | 803.9 | 989.9 | 903.4 | 1,065.2 |
| **uint8** | N/A | 234.5 | 351.8 | 531.4 | 776.9 |
| **uint16** | N/A | 367.5 | 624.8 | 675.0 | 977.8 |
| **uint32** | N/A | 603.6 | 779.2 | 953.0 | 1,055.7 |
| **uint64** | N/A | 787.1 | 946.1 | 1,076.0 | 1,065.5 |
...
| DType | Dim 128 | Dim 384 | Dim 768 | Dim 1536 | Dim 3072 |
|-------|---------|---------|---------|----------|----------|
| **float32** | N/A | 665.2 | 884.4 | 1,018.3 | 962.9 |
| **float64** | N/A | 638.3 | 705.7 | 806.4 | 851.9 |
| **float16** | N/A | 450.7 | 590.4 | 655.9 | 758.1 |
| **int8** | N/A | 352.5 | 458.4 | 605.8 | 619.7 |
| **int16** | N/A | 647.9 | 788.3 | 800.8 | 902.5 |
| **int32** | N/A | 694.0 | 611.4 | 812.9 | 808.0 |
| **int64** | N/A | 879.9 | 1,032.2 | 1,021.0 | 1,046.3 |
| **uint8** | N/A | 323.8 | 367.5 | 660.3 | 603.3 |
| **uint16** | N/A | 461.6 | 771.1 | 930.5 | 956.1 |
| **uint32** | N/A | 561.3 | 689.5 | 781.3 | 890.7 |
| **uint64** | N/A | 931.5 | 1,132.5 | 1,107.8 | 1,049.2 |
...
| DType | Dim 128 | Dim 384 | Dim 768 | Dim 1536 | Dim 3072 |
|-------|---------|---------|---------|----------|----------|
| **float32** | N/A | 2,007 | 1,577 | 964 | 594 |
| **float64** | N/A | 2,763 | 2,327 | 1,750 | 1,004 |
| **float16** | N/A | 2,637 | 2,212 | 1,597 | 913 |
| **int8** | N/A | 2,897 | 2,285 | 1,634 | 1,061 |
| **int16** | N/A | 5,858 | 4,877 | 2,927 | 1,796 |
| **int32** | N/A | 2,892 | 2,275 | 1,642 | 1,052 |
| **int64** | N/A | 5,412 | 5,052 | 2,953 | 1,801 |
| **uint8** | N/A | 2,907 | 2,357 | 1,681 | 1,085 |
| **uint16** | N/A | 5,905 | 4,423 | 3,147 | 1,847 |
| **uint32** | N/A | 2,841 | 2,158 | 1,597 | 1,113 |
| **uint64** | N/A | 5,719 | 4,257 | 2,945 | 1,789 |
...
| DType | Dim 128 | Dim 384 | Dim 768 | Dim 1536 | Dim 3072 |
|-------|---------|---------|---------|----------|----------|
| **float32** | N/A | 0.472 | 0.604 | 1.005 | 1.647 |
| **float64** | N/A | 0.344 | 0.414 | 0.557 | 0.980 |
| **float16** | N/A | 0.363 | 0.440 | 0.607 | 1.062 |
| **int8** | N/A | 0.335 | 0.421 | 0.587 | 0.931 |
| **int16** | N/A | 0.155 | 0.197 | 0.337 | 0.545 |
| **int32** | N/A | 0.323 | 0.426 | 0.583 | 0.944 |
| **int64** | N/A | 0.178 | 0.184 | 0.326 | 0.541 |
| **uint8** | N/A | 0.330 | 0.415 | 0.579 | 0.909 |
| **uint16** | N/A | 0.165 | 0.222 | 0.307 | 0.531 |
| **uint32** | N/A | 0.334 | 0.451 | 0.604 | 0.870 |
| **uint64** | N/A | 0.170 | 0.220 | 0.327 | 0.553 |
...
| DType | Dim 128 | Dim 384 | Dim 768 | Dim 1536 | Dim 3072 |
|-------|---------|---------|---------|----------|----------|
| **float32** | N/A | 0.648 | 0.757 | 1.169 | 1.958 |
| **float64** | N/A | 0.481 | 0.565 | 0.704 | 1.166 |
| **float16** | N/A | 0.487 | 0.548 | 0.733 | 1.255 |
| **int8** | N/A | 0.453 | 0.547 | 0.815 | 1.019 |
| **int16** | N/A | 0.217 | 0.336 | 0.385 | 0.638 |
| **int32** | N/A | 0.484 | 0.535 | 0.722 | 1.072 |
| **int64** | N/A | 0.289 | 0.256 | 0.452 | 0.659 |
| **uint8** | N/A | 0.440 | 0.516 | 0.740 | 1.043 |
| **uint16** | N/A | 0.214 | 0.278 | 0.394 | 0.611 |
| **uint32** | N/A | 0.481 | 0.544 | 0.877 | 1.016 |
| **uint64** | N/A | 0.223 | 0.289 | 0.423 | 0.636 |
...
| DType | Dim 128 | Dim 384 | Dim 768 | Dim 1536 | Dim 3072 |
|-------|---------|---------|---------|----------|----------|
| **float32** | N/A | 0.734 | 1.038 | 1.398 | 2.166 |
| **float64** | N/A | 0.575 | 0.734 | 0.879 | 1.406 |
| **float16** | N/A | 0.588 | 0.657 | 0.897 | 1.426 |
| **int8** | N/A | 0.513 | 0.636 | 0.824 | 1.166 |
| **int16** | N/A | 0.389 | 0.350 | 0.499 | 0.740 |
| **int32** | N/A | 0.538 | 0.760 | 0.983 | 1.263 |
| **int64** | N/A | 0.307 | 0.348 | 0.559 | 0.794 |
| **uint8** | N/A | 0.502 | 0.558 | 0.826 | 1.143 |
| **uint16** | N/A | 0.284 | 0.351 | 0.471 | 0.676 |
| **uint32** | N/A | 0.548 | 0.786 | 0.937 | 1.242 |
| **uint64** | N/A | 0.304 | 0.443 | 0.518 | 0.792 |
...
|---------------|---------|------------------|------------------|
| 1,000 | 100 | 13.23 | 1.39 |
| 1,000 | 500 | 44.21 | 0.84 |
| 1,000 | 1,000 | 73.23 | 0.78 |