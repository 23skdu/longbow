...
// HNSWGraphSync manages the synchronization state of the HNSW graph.
type HNSWGraphSync struct {
	index       types.VectorIndexer
	mu          sync.RWMutex
...
func NewHNSWGraphSync(index types.VectorIndexer) *HNSWGraphSync {
