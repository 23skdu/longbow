...
Longbow 0.2.0 implements a **Zero-Copy** data plane using Apache Arrow. Vectors are accessed directly from memory-mapped files during HNSW traversal, eliminating heap allocations and significantly reducing GC pressure.
