...
func (idx *IVFPQIndex) SearchInternal(ctx context.Context, queryVec []float32, k int, filter *roaring.Bitmap, _ types.SearchOptions) ([]types.SearchResult, error) {
...
func (idx *IVFPQIndex) SearchVectorsWithBitmap(ctx context.Context, q any, k int, filter *roaring.Bitmap, options any) ([]types.SearchResult, error) {
	...
	opts, _ := options.(types.SearchOptions)
...
func (idx *IVFPQIndex) SearchVectorsInRange(ctx context.Context, q any, threshold float32, filters []query.Filter, options any) ([]SearchResult, error) {
	...
	allResults, err := idx.SearchInternal(ctx, qF32, int(idx.nextID), nil, types.SearchOptions{})
	if err != nil {
		return nil, err
	}
