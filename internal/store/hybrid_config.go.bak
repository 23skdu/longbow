...
// =============================================================================
// HybridSearchConfig - Configuration for BM25 + Vector Hybrid Search
// =============================================================================
...
// IsPureVector returns true if Alpha=1.0 (pure vector search, no keyword component)
func (c *HybridSearchConfig) IsPureVector() bool {
	return c.Alpha >= 1.0
}

// IsPureKeyword returns true if Alpha=0.0 (pure BM25 keyword search, no vector component)
