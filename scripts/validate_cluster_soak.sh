...
python3 scripts/perf_test.py --concurrent 4 --duration 30 --dim 384 --name soak_n1 --operation mixed --data-uri grpc://localhost:3000 --meta-uri grpc://localhost:3001

# 4. Soak Test Node 2
echo ">>> [3/5] Soak Testing Node 2 (30s)..."
python3 scripts/perf_test.py --concurrent 4 --duration 30 --dim 384 --name soak_n2 --operation mixed --data-uri grpc://localhost:3010 --meta-uri grpc://localhost:3011

# 5. Soak Test Node 3
echo ">>> [4/5] Soak Testing Node 3 (30s)..."
python3 scripts/perf_test.py --concurrent 4 --duration 30 --dim 384 --name soak_n3 --operation mixed --data-uri grpc://localhost:3020 --meta-uri grpc://localhost:3021
