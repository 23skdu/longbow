...
func TestGraphData_ArenaNeighbors(t *testing.T) {
	...
	// NewGraphData signature: func NewGraphData(capacity, dims int, sq8, pq, bq bool, false, false) *GraphData
	// The new signature is likely: func NewGraphData(capacity, dims int, sq8, pq bool, pqDims int, bq bool, false, false) *GraphData
	initialCapacity := 100
	dims := 128
	data := NewGraphData(initialCapacity, dims, false, false, 0, false, false, false)
...
func TestGraphData_ArenaGrowth(t *testing.T) {
	...
	gd := NewGraphData(10000, 16, false, false, 0, false, false, false)
