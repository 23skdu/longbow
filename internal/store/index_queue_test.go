...
if cfg.MainChannelSize != 10000 {
t.Errorf("MainChannelSize: got %d, want 10000", cfg.MainChannelSize)
}
if cfg.OverflowBufferSize != 100000 {
t.Errorf("OverflowBufferSize: got %d, want 100000", cfg.OverflowBufferSize)
}
if cfg.DrainInterval != 1*time.Millisecond {
t.Errorf("DrainInterval: got %v, want 1ms", cfg.DrainInterval)
}
}
