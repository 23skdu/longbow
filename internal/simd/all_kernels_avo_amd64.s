...
// func l2SquaredFloat64AVX2Kernel(a uintptr, b uintptr, n int) float32
// Requires: AVX, FMA3, SSE
TEXT ·l2SquaredFloat64AVX2Kernel(SB), NOSPLIT, $0-28
	MOVQ   a+0(FP), AX
	MOVQ   b+8(FP), CX
	MOVQ   n+16(FP), DX
	VXORPD Y0, Y0, Y0
...
// func cosineFloat64AVX2Kernel(a uintptr, b uintptr, n int) (dot float32, normA float32, normB float32)
// Requires: AVX, FMA3, SSE
TEXT ·cosineFloat64AVX2Kernel(SB), NOSPLIT, $0-36
	MOVQ   a+0(FP), AX
	MOVQ   b+8(FP), CX
	MOVQ   n+16(FP), DX
	VXORPD Y0, Y0, Y0
...
tail:
	VEXTRACTF128 $0x00, Y0, X3
	VEXTRACTF128 $0x01, Y0, X0
	VADDPD       X3, X0, X0
	VUNPCKHPD    X0, X0, X3
	VADDSD       X3, X0, X0
	VEXTRACTF128 $0x00, Y1, X3
	VEXTRACTF128 $0x01, Y1, X1
	VADDPD       X3, X1, X1
	VUNPCKHPD    X1, X1, X3
	VADDSD       X3, X1, X1
...
scalar_loop:
	...
	VFMADD231SD X3, X3, X1
	VFMADD231SD X4, X4, X2
	ADDQ        $0x08, AX
	ADDQ        $0x08, CX
	DECQ        DX
	JMP         scalar_loop
...
store:
	...
	VCVTSD2SS X2, X2, X2
	MOVSS     X0, dot+24(FP)
	MOVSS     X1, normA+28(FP)
	MOVSS     X2, normB+32(FP)
	VZEROUPPER
	RET

// func l2Squared128Float64AVX2Kernel(a uintptr, b uintptr) float32
// Requires: AVX, FMA3, SSE
TEXT ·l2Squared128Float64AVX2Kernel(SB), NOSPLIT, $0-20
	MOVQ         a+0(FP), AX
	MOVQ         b+8(FP), CX
	VXORPD       Y0, Y0, Y0
	VMOVUPD      (AX), Y1
...
// func dot128Float64AVX2Kernel(a uintptr, b uintptr) float32
// Requires: AVX, FMA3, SSE
TEXT ·dot128Float64AVX2Kernel(SB), NOSPLIT, $0-20
	MOVQ         a+0(FP), AX
	MOVQ         b+8(FP), CX
	VXORPD       Y0, Y0, Y0
	VMOVUPD      (AX), Y1
...
// func euclidean128Float64AVX2Kernel(a uintptr, b uintptr) float32
// Requires: AVX, FMA3, SSE
TEXT ·euclidean128Float64AVX2Kernel(SB), NOSPLIT, $0-20
	MOVQ         a+0(FP), AX
	MOVQ         b+8(FP), CX
	VXORPD       Y0, Y0, Y0
	VMOVUPD      (AX), Y1
...
// func l2Squared384Float64AVX2Kernel(a uintptr, b uintptr) float32
// Requires: AVX, FMA3, SSE
TEXT ·l2Squared384Float64AVX2Kernel(SB), NOSPLIT, $0-20
	MOVQ         a+0(FP), AX
	MOVQ         b+8(FP), CX
	VXORPD       Y0, Y0, Y0
	VMOVUPD      (AX), Y1
...
// func dot384Float64AVX2Kernel(a uintptr, b uintptr) float32
// Requires: AVX, FMA3, SSE
TEXT ·dot384Float64AVX2Kernel(SB), NOSPLIT, $0-20
	MOVQ         a+0(FP), AX
	MOVQ         b+8(FP), CX
	VXORPD       Y0, Y0, Y0
	VMOVUPD      (AX), Y1
...
// func euclidean384Float64AVX2Kernel(a uintptr, b uintptr) float32
// Requires: AVX, FMA3, SSE
TEXT ·euclidean384Float64AVX2Kernel(SB), NOSPLIT, $0-20
	MOVQ         a+0(FP), AX
	MOVQ         b+8(FP), CX
	VXORPD       Y0, Y0, Y0
	VMOVUPD      (AX), Y1
...
// func l2Squared768Float64AVX2Kernel(a uintptr, b uintptr) float32
// Requires: AVX, FMA3, SSE
TEXT ·l2Squared768Float64AVX2Kernel(SB), NOSPLIT, $0-20
	MOVQ         a+0(FP), AX
	MOVQ         b+8(FP), CX
	VXORPD       Y0, Y0, Y0
	VMOVUPD      (AX), Y1
...
// func dot768Float64AVX2Kernel(a uintptr, b uintptr) float32
// Requires: AVX, FMA3, SSE
TEXT ·dot768Float64AVX2Kernel(SB), NOSPLIT, $0-20
	MOVQ         a+0(FP), AX
	MOVQ         b+8(FP), CX
	VXORPD       Y0, Y0, Y0
	VMOVUPD      (AX), Y1
...
// func euclidean768Float64AVX2Kernel(a uintptr, b uintptr) float32
// Requires: AVX, FMA3, SSE
TEXT ·euclidean768Float64AVX2Kernel(SB), NOSPLIT, $0-20
	MOVQ         a+0(FP), AX
	MOVQ         b+8(FP), CX
	VXORPD       Y0, Y0, Y0
	VMOVUPD      (AX), Y1
...
// func l2SquaredFloat64AVX512Kernel(a uintptr, b uintptr, n int) float32
// Requires: AVX, AVX512DQ, AVX512F, FMA3, SSE
TEXT ·l2SquaredFloat64AVX512Kernel(SB), NOSPLIT, $0-28
	MOVQ   a+0(FP), AX
	MOVQ   b+8(FP), CX
	MOVQ   n+16(FP), DX
	VXORPD Z0, Z0, Z0
...
// func cosineFloat64AVX512Kernel(a uintptr, b uintptr, n int) (dot float32, normA float32, normB float32)
// Requires: AVX, AVX512DQ, AVX512F, FMA3, SSE
TEXT ·cosineFloat64AVX512Kernel(SB), NOSPLIT, $0-36
	MOVQ   a+0(FP), AX
	MOVQ   b+8(FP), CX
	MOVQ   n+16(FP), DX
	VXORPD Z0, Z0, Z0
...
loop:
	...
	VMOVUPD     (AX), Z3
	VMOVUPD     (CX), Z4
	VFMADD231PD Z3, Z4, Z0
	VFMADD231PD Z3, Z3, Z1
	VFMADD231PD Z4, Z4, Z2
	ADDQ        $0x40, AX
	ADDQ        $0x40, CX
	SUBQ        $0x08, DX
	JMP         loop
