...
type BatchDistanceFunc func(query []float32, vectors [][]float32, results []float32) error

// BatchDistanceSQ8Func is the function signature for SQ8 batch distance.
type BatchDistanceSQ8Func func(query []byte, vectors [][]byte, results []float32) error
