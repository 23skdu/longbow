...
TEXT ·int8ToFloat32AVX2Kernel(SB), NOSPLIT, $0
    MOVQ    src+0(FP), SI
    MOVQ    dst+8(FP), DI
    MOVQ    n+16(FP), BX
...
TEXT ·uint8ToFloat32AVX2Kernel(SB), NOSPLIT, $0
    MOVQ    src+0(FP), SI
    MOVQ    dst+8(FP), DI
    MOVQ    n+16(FP), BX
...
TEXT ·int16ToFloat32AVX2Kernel(SB), NOSPLIT, $0
    MOVQ    src+0(FP), SI
    MOVQ    dst+8(FP), DI
    MOVQ    n+16(FP), BX
...
TEXT ·uint16ToFloat32AVX2Kernel(SB), NOSPLIT, $0
    MOVQ    src+0(FP), SI
    MOVQ    dst+8(FP), DI
    MOVQ    n+16(FP), BX
...
TEXT ·int32ToFloat32AVX2Kernel(SB), NOSPLIT, $0
    MOVQ    src+0(FP), SI
    MOVQ    dst+8(FP), DI
    MOVQ    n+16(FP), BX
...
TEXT ·uint32ToFloat32AVX2Kernel(SB), NOSPLIT, $0
    MOVQ    src+0(FP), SI
    MOVQ    dst+8(FP), DI
    MOVQ    n+16(FP), BX
    JMP     done_u32_f32
...
TEXT ·float16ToFloat32AVX2Kernel(SB), NOSPLIT, $0
    MOVQ    src+0(FP), SI
    MOVQ    dst+8(FP), DI
    MOVQ    n+16(FP), BX
